...
-- Populate Facilities
insert into JAM_OWNER.FACILITY (FACILITY_ID, NAME, PATH, MANAGER_USERNAME, LOGBOOKS_CSV, WEIGHT) values (1, 'CEBAF', '/cebaf', 'tbrown', 'TLOG',  1);
insert into JAM_OWNER.FACILITY (FACILITY_ID, NAME, PATH, MANAGER_USERNAME, LOGBOOKS_CSV, WEIGHT) values (2, 'LERF', '/lerf', 'tbrown', 'TLOG', 2);
insert into JAM_OWNER.FACILITY (FACILITY_ID, NAME, PATH, MANAGER_USERNAME, LOGBOOKS_CSV, WEIGHT) values (3, 'UITF', '/uitf', 'tbrown', 'TLOG', 3);
insert into JAM_OWNER.FACILITY (FACILITY_ID, NAME, PATH, MANAGER_USERNAME, LOGBOOKS_CSV, WEIGHT) values (4, 'CMTF', '/cmtf', 'tbrown', 'TLOG', 4);
insert into JAM_OWNER.FACILITY (FACILITY_ID, NAME, PATH, MANAGER_USERNAME, LOGBOOKS_CSV, WEIGHT) values (5, 'VTA', '/vta', 'tbrown', 'TLOG', 5);
...
-- Populate Watchers
insert into JAM_OWNER.WATCHER (FACILITY_ID, OPERATIONS_TYPE, USERNAME) values (1, 'RF', 'tbrown');
insert into JAM_OWNER.WATCHER (FACILITY_ID, OPERATIONS_TYPE, USERNAME) values (1, 'BEAM', 'tbrown');

-- Populate Credited Controls
insert into JAM_OWNER.CREDITED_CONTROL (CREDITED_CONTROL_ID,NAME,DESCRIPTION,VERIFICATION_TEAM_ID,WEIGHT,VERIFICATION_FREQUENCY, DOC_LABEL_URL_CSV) values (JAM_OWNER.CREDITED_CONTROL_ID.nextval,'Earth Berms/Overburden','Non-structural fill, cover, or berms',1,1,'1 Year', 'CEBAF-LERF ASE 3.1.1|https://jlabdoc.jlab.org/docushare/dsweb/Get/Document-187898#page=12');
insert into JAM_OWNER.CREDITED_CONTROL (CREDITED_CONTROL_ID,NAME,DESCRIPTION,VERIFICATION_TEAM_ID,WEIGHT,VERIFICATION_FREQUENCY, DOC_LABEL_URL_CSV) values (JAM_OWNER.CREDITED_CONTROL_ID.nextval,'Structural Shielding','Beam enclosure concrete structure',2,2,'1 Year', 'CEBAF-LERF ASE 3.1.1|https://jlabdoc.jlab.org/docushare/dsweb/Get/Document-187898#page=12,UITF ASE 4.1.1|https://jlabdoc.jlab.org/docushare/dsweb/Get/Document-203051#page=8');
insert into JAM_OWNER.CREDITED_CONTROL (CREDITED_CONTROL_ID,NAME,DESCRIPTION,VERIFICATION_TEAM_ID,WEIGHT,VERIFICATION_FREQUENCY, DOC_LABEL_URL_CSV) values (JAM_OWNER.CREDITED_CONTROL_ID.nextval,'Movable Shielding','Includes penetrations',1,3,'1 Year', 'Testing');
