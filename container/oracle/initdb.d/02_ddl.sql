...
(
    ...
    BEAM_AUTHORIZATION_ID INTEGER NOT NULL,
    FACILITY_ID           INTEGER NOT NULL,
    BEAM_MODE             VARCHAR2(16 CHAR) NOT NULL,
    CW_LIMIT              NUMBER(24,12) NULL,
    COMMENTS              VARCHAR2(256 CHAR) NULL,
    EXPIRATION_DATE       DATE NULL,
    AUTOMATED_YN          VARCHAR2(1 BYTE) DEFAULT 'N' NOT NULL,
    ...
    CONSTRAINT BEAM_DESTINATION_AUTHORIZATION_CK2 CHECK (AUTOMATED_YN IN ('Y', 'N'))
);
...
(
    ...
    CONSTRAINT RF_SEGMENT_AUTHORIZATION_CK2 CHECK (AUTOMATED_YN IN ('Y', 'N'))
);
...
(
    ...
    DOC_LABEL_URL_CSV      VARCHAR2(4000 CHAR) NULL,
...
(
    ...
    EXPIRATION_DATE            DATE NULL,
    COMMENTS                   VARCHAR2(2048 CHAR) NULL,
    EXTERNAL_URL               VARCHAR2(4000 CHAR) NULL,
    MODIFIED_BY                VARCHAR2(64 CHAR) NOT NULL,
    MODIFIED_DATE              DATE NOT NULL,
    EXPIRATION_YN              VARCHAR2(1 BYTE) DEFAULT 'N' NOT NULL,
    ...
    CONSTRAINT RF_CONTROL_VERIFICATION_CK1 CHECK (EXPIRATION_YN IN ('Y', 'N'))
);
...
(
    ...
    CONSTRAINT BEAM_CONTROL_VERIFICATION_CK1 CHECK (EXPIRATION_YN IN ('Y', 'N'))
);
