...
@WebServlet(
    name = "AddAuthorizer",
    urlPatterns = {"/ajax/add-authorizer"})
public class AddAuthorizer extends HttpServlet {

  private static final Logger LOGGER = Logger.getLogger(AddAuthorizer.class.getName());
  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      LOGGER.log(Level.SEVERE, "Unable to add authorizer", e);
