...
import org.jlab.jam.business.session.DailyScheduledCheck;
 ...
 */
@WebServlet(
    name = "ForceExpirationCheckAll",
    urlPatterns = {"/ajax/expiration"})
public class ForceExpirationCheckAll extends HttpServlet {

  private static final Logger LOGGER = Logger.getLogger(ForceExpirationCheckAll.class.getName());

  @EJB DailyScheduledCheck check;
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      LOGGER.log(Level.SEVERE, "Unable to force expiration check", e);
