 ...
 * @author ryans
 */
@WebServlet(name = "RFAuthorizationHistoryController")
public class RFAuthorizationHistoryController extends HttpServlet {

  @EJB RFAuthorizationFacade historyFacade;
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    List<RFSegment> historyList = historyFacade.findHistory(facility, offset, maxPerPage);
