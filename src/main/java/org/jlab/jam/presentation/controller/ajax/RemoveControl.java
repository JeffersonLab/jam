...
@WebServlet(
    name = "RemoveControl",
    urlPatterns = {"/ajax/remove-control"})
public class RemoveControl extends HttpServlet {

  private static final Logger LOGGER = Logger.getLogger(RemoveControl.class.getName());
  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      controlFacade.removeControl(controlId);
      ...
      LOGGER.log(Level.SEVERE, "Unable to remove control", e);
