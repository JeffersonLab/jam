...
@WebServlet(
    name = "AddControl",
    urlPatterns = {"/ajax/add-control"})
public class AddControl extends HttpServlet {

  private static final Logger LOGGER = Logger.getLogger(AddControl.class.getName());
  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      controlFacade.addControl(name, description, doc, teamId, frequency);
      ...
      LOGGER.log(Level.SEVERE, "Unable to add control", e);
