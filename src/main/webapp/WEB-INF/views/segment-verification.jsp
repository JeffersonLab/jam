                                    ...
                                    <tbody>
                                        <c:forEach items="${segment.getRFControlVerificationList()}" var="verification">
                                            <tr data-control-verification-id="${verification.getRFControlVerificationId()}" data-verified-username="${verification.verifiedBy}" data-status-id="${verification.verificationStatusId}">
                                                ...
                                                <td><a class="small-icon dialog-ready comment-icon" data-dialog-title="Verification History" href="credited-controls/verification-history?rfControlVerificationId=${verification.getRFControlVerificationId()}" title="Click for verification history"></a></td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
                                </table>
