...
<c:set var="title" value="Event Watchers"/>
                ...
                <table class="data-table stripped-table ${readonly ? '' : 'uniselect-table editable-row-table'}">
                    ...
                    <c:forEach items="${facilityList}" var="facility">
                        <tr data-id="${facility.facilityId}">
                            <td><c:out value="MCCOPS (mccops)"/></td>
                            <td><c:out value="UPCOMING_EXPIRATION"/></td>
                            <td><c:out value="${facility.name}"/></td>
                        </tr>
                        <tr data-id="${facility.facilityId}">
                            <td><c:out value="MCCOPS (mccops)"/></td>
                            <td><c:out value="VERIFICATION_DOWNGRADED"/></td>
                            <td><c:out value="${facility.name}"/></td>
                        </tr>
                        <tr data-id="${facility.facilityId}">
                            <td><c:out value="MCCOPS (mccops)"/></td>
                            <td><c:out value="AUTHORIZATION_DOWNGRADED"/></td>
                            <td><c:out value="${facility.name}"/></td>
                        </tr>
                    </c:forEach>
                    </tbody>
